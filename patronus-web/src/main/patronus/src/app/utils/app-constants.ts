...
export class AppContants {
    ...
    public static NO_PERMISION_PATH = `${AppContants.BASE_PATH}/no-permision`
    public static PATRON_PATH = `${AppContants.BASE_PATH}/patron`;
    ...
    public static USUARIO_PATH = `${AppContants.BASE_PATH}/usuario`;
    ...
    public static GRUPO_PATH = `${AppContants.BASE_PATH}/grupo`
    ...
    public static EJERCICIO_PATH = `${AppContants.BASE_PATH}/ejercicio`
